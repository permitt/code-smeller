final class Prefixes {
     ...
     * character “”. The Greek letter  is repeated twice: the U+00B5 character for micro sign (this is the character
     ...
     */
    private static final char[] PREFIXES = {'E','G','M','P','T','Y','Z','a','c','d','f','h','k','m','n','p','y','z','µ','',''};
